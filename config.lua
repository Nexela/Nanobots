...
NANO.AUTO_GOBBLE = true --default: true, set to false to disable looting alien artifacts and other items on ground
NANO.AUTO_BUILD = true --default: true, set to false to enable builder-planner item, greatly improved performance
